      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4">
          <div
            style={{
              ...
              borderRadius: 12,
              background:
                "linear-gradient(135deg, rgba(91,140,255,0.14), rgba(6,52,90,0.06))",
              display: "flex",
              alignItems: "center",
          ...
          <div>
            ...
            <p className="text-sm text-location">
        ...
        <div className="flex flex-col items-end gap-3">
          ...
          <div className="flex gap-2">
            <Link
              aria-label={`Ouvrir le site ${site.name}`}
              to={`/site/${site.id}`}
            ...
            <Link
              aria-label={`Voir les audits du site ${site.name}`}
              to={`/audit?site=${site.id}`}
