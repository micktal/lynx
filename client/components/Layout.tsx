  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
        ...
        <div className="container mx-auto flex items-center justify-between gap-4 py-3">
          <div className="flex items-center gap-4">
            <Link to="/" className="flex items-center gap-3">
              <img
                src="https://cdn.builder.io/api/v1/image/assets%2Fd93d9a0ec7824aa1ac4d890a1f90a2ec%2F55a8c512fb5d4bb38b0292e3757d0114?format=webp&width=400"
                alt="ROEH logo"
              ...
              <div>
                ...
                <div className="text-xs" style={{ color: "var(--text-muted)" }}>
                  Security Inspection & Risk Intelligence Platform
                </div>
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-3">
            <nav className="hidden md:flex items-center gap-4">
              <Link to="/login" className="text-sm" style={{ color: "var(--text)" }}>
                Sites
              </Link>
              <Link
                to="/map-france"
      ...
      >
        ...
        >
          <div
            className="flex flex-col md:flex-row md:justify-between gap-6 text-sm"
            style={{ color: "var(--text-muted)" }}
          >
            <div>
              © {new Date().getFullYear()} ROEH — Security Inspection & Risk
