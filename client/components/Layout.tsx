        ...
        <div className="container mx-auto flex items-center justify-between gap-4 py-3">
          <div className="flex items-center gap-4">
            <Link to="/" className="flex items-center gap-3">
              <img src="https://cdn.builder.io/api/v1/image/assets%2Fd93d9a0ec7824aa1ac4d890a1f90a2ec%2F55a8c512fb5d4bb38b0292e3757d0114?format=webp&width=400" alt="ROEH logo" className="w-20 h-20 rounded-md object-contain" style={{ background: 'transparent' }} />
              <div>
          ...
          <div className="flex items-center gap-3">
            <nav className="hidden md:flex items-center gap-4">
              ...
              {(() => { const u = getCurrentUser(); return (u && u.role === 'ADMIN') ? <>
                <Link to="/admin/rules" className="text-sm" style={{ color: "var(--text-muted)" }}>Admin</Link>
                <Link to="/admin/users" className="text-sm" style={{ color: "var(--text-muted)" }}>Users</Link>
              </> : null })()}
            </nav>
