...
export default function Hero(){
  ...
  return (
    <div className="w-full" style={{ position: 'relative', marginBottom: 12 }}>
      <div style={{
        background: 'linear-gradient(135deg, rgba(10,132,255,0.08), rgba(32,201,151,0.06))',
        height: 160,
        borderRadius: 12,
        display: 'flex',
        alignItems: 'center',
      ...
      <div style={{ position: 'absolute', left: 24, top: 8, width: 90, height: 90, borderRadius: 9999, background: 'rgba(91,140,255,0.06)', filter: 'blur(18px)', zIndex: 0 }} />
      <div style={{ position: 'absolute', right: 24, top: 24, width: 60, height: 60, borderRadius: 9999, background: 'rgba(32,201,151,0.06)', filter: 'blur(12px)', zIndex: 0 }} />
    </div>
  );
}
