  ...
  if (id==='new') {
    return (
      <Layout>
        ...
        <div className="mt-4"><button className="btn" onClick={()=>navigate('/projects')}>Retour</button></div>
      </Layout>
    );
  }
    ...
    <Layout>
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          <button className="btn" onClick={handleRecalc}>Recalculer progression</button>
          <Link to="/projects" className="btn-ghost">Retour</Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2 card">
          ...
          <div className="mt-3 space-y-3">
            {chantiers.map(c => (
              <div key={c.id} className="p-3 bg-card-2 rounded-md flex items-center justify-between">
                <div>
                ...
                <div className="text-right">
                  ...
                  <div className="mt-2"><Link to={`/chantier/${c.id}`} className="text-sm">Ouvrir</Link></div>
                </div>
              </div>
            ))}
          </div>
